...
<body>
    <div class="container">
        <div class="row align-items-start pt-5">
            <form method="post" action="<?= site_url('/submitregister') ?>"
                class="pt-3 col-md-4 shadow-sm bg-body-tertiary rounded mx-auto">
                ...
                <p class="pt-3">Anda Sudah Punya Akun? <a href="/user/login">login</a></p>
            </form>
        </div>
    </div>
